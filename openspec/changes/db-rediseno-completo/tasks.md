...
- [x] 4.1 Append `DOCUMENTO_ASOCIADO` with audit columns, `CAT_IDIOMA`, `CAT_FORMATO_DOCUMENTO`, `CAT_TIPO_DOCUMENTO_ASOCIADO`, `CAT_DOCUMENTO_FAMILIA`
- [x] 4.2 Append `DOCUMENTO_SECCION`, `REL_DOCUMENTO_DOCUMENTO` with `CAT_TIPO_RELACION_DOCUMENTO`
- [x] 4.3 Append document-entity relations: `REL_DOCUMENTO_MUESTRA`, `REL_DOCUMENTO_PLACA`, `REL_DOCUMENTO_POZO`, `REL_DOCUMENTO_PROYECTO`, `REL_DOCUMENTO_SECCION_ESTRATIGR`
- [x] 4.4 Append localization: `CAT_PAIS`, `CAT_DEPARTAMENTO`, `CAT_MUNICIPIO`, `LOCALIZACION_GEOGRAFICA`, `LOCALIZACION_ESPACIAL`, `LOCALIZACION_GEOREFERENCIAL`
- [x] 4.5 Append spatial catalogs: `CAT_SISTEMA_COORD`, `CAT_METODO_ESPACIAL`, `CAT_FUENTE_ESPACIAL`, `CAT_PRECISION_ESPACIAL`, `CAT_PLANCHA_TOPOGRAFICA`, `CAT_POLIGONAL`, `CAT_NIVEL_DETALLE_LOCALIDAD`
- [x] 4.6 Append stratigraphic: `SECCION_ESTRATIGRAFICA`, `POSICION_ESTRATIGRAFICA`, `CAT_VIA_NORM`, `CAT_ACCIDENTE_GEOGRAFICO_NORM`, `CAT_TIPO_PUNTO_MUESTREO`
